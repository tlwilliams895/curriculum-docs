...
2. Create an example or project that hits the objectives
...
-  It’s okay to mess up. If you do make a mistake, take a moment, make a note of what needs to be edited, back up, and continue.
-  It can be a good thing to work through an error or bug in the lesson; this normalizes the situation for learners. If learners only see you going through examples perfectly and never messing up then they get the impression that more experienced developers never make mistakes.
